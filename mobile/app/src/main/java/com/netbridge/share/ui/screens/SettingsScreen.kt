    ...
    Column(
        ...
        Surface(
            ...
            Column(Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(12.dp))
                Text(
                    stringResource(R.string.built_by),
                    color = TextSecondary,
                    style = MaterialTheme.typography.bodySmall
                )
                Spacer(Modifier.height(8.dp))
                AuthorLink(stringResource(R.string.link_github), "https://github.com/MohammadMehdiSadeghi")
                AuthorLink(stringResource(R.string.link_linkedin), "https://www.linkedin.com/in/mohammad-mehdi-sadeghi")
            }
        }
...
@Composable
private fun AuthorLink(label: String, url: String) {
    val context = LocalContext.current
    Row(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Icon(Icons.Default.Link, contentDescription = null, tint = Brand, modifier = Modifier.width(18.dp))
        Spacer(Modifier.width(8.dp))
        Text(label, color = Brand, style = MaterialTheme.typography.titleSmall)
    }
}
